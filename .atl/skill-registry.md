...
| `nextjs-docs-v16-3` | Next.js v16.3 bundled documentation. Snapshot of node_modules/next/dist/docs/. Use when working on Next.js to read current API patterns and per-error guides. Files in docs/ mirror the official docs tree exactly. | user | `/home/lucas/.agents/skills/.nextjs-docs-v16-3.bak/SKILL.md` |
