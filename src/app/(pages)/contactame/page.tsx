...
export const metadata: Metadata = {
  ...
  description:
    'Contacta con el creador de TuAmigoFI. WhatsApp, Instagram o Email para consultas, reportes de errores o sugerencias.',
};
    ...
    <>
      <main className="pt-14 relative flex text-(--black) w-11/12 justify-center mx-auto max-w-(--breakpoint-md) my-10 sm:pt-20 sm:justify-center">
        ...
        <h1 className="font-bold text-4xl text-left bg-[#F3F4F6] ml-1 p-1 h-min rounded-2xl rounded-es-none shadow-md sm:ml-6 sm:p-2">
          Hola! 🥰<p className="whitespace-nowrap text-xl font-normal">Aquí podrás contactarme.</p>
        </h1>
      </main>
      <section className="grow flex flex-col justify-start items-center text-(--black) w-11/12 mx-auto max-w-(--breakpoint-md)">
        <div className="text-center text-base sm:text-base m-6">
          <p className="mb-4">
            Si tenés alguna <strong>consulta</strong>, querés <strong>reportar un error</strong>,
            saber cómo hice esta página o simplemente <strong>charlar</strong>, no dudes en
            contactarme. Estoy más que dispuesto a ayudarte en lo que necesites.
          </p>
          <p className="mb-4">
            También me encantaría recibir tus <strong>ideas</strong> o <strong>sugerencias</strong>{' '}
            para mejorar. ¡Toda <strong>opinión</strong> es bienvenida y me ayuda a hacer que esta
