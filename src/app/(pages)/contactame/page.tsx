    ...
    <>
      <main className="pt-14 relative flex text-(--black) w-11/12 justify-center mx-auto max-w-(--breakpoint-md) my-10 sm:pt-20 sm:justify-center">
        ...
        <h1 className="font-bold text-4xl text-left bg-[#F3F4F6] ml-1 p-1 h-min rounded-2xl rounded-es-none shadow-md sm:ml-6 sm:p-2">
          Hola! 🥰
          <p className="whitespace-nowrap text-xl font-normal">Aquí podrás contactarme.</p>
        </h1>
      </main>
      <section className="grow flex flex-col justify-start items-center text-(--black) w-11/12 mx-auto max-w-(--breakpoint-md)">
        <div className="text-center text-base sm:text-base m-6">
          <p className="mb-4">
            Si tenés alguna <strong>consulta</strong>, querés <strong>reportar un error</strong>, saber cómo hice esta página o simplemente{' '}
            <strong>charlar</strong>, no dudes en contactarme. Estoy más que dispuesto a ayudarte en lo que necesites.
          </p>
          <p className="mb-4">
            También me encantaría recibir tus <strong>ideas</strong> o <strong>sugerencias</strong> para mejorar. ¡Toda <strong>opinión</strong> es bienvenida y
            me ayuda a hacer que esta página sea más útil para vos y para toda la comunidad!
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 w-full mt-4">
          ...
          >
            <Image className="object-contain rounded-md p-1" src="/instagram.svg" width={35} height={35} alt="Instagram" />
          ...
          >
            <Image className="object-contain rounded-md p-1" src="/whatsapp.svg" width={35} height={35} alt="WhatsApp" />
            <span className="relative px-2 py-1 transition-all ease-in duration-75 bg-(--white) rounded-md text-base group-hover:bg-transparent">
          ...
          >
            <Image className="object-contain rounded-md p-0.5" src="/email.svg" width={35} height={35} alt="Email" />
            <span className="relative px-2 py-1 transition-all ease-in duration-75 bg-(--white) rounded-md text-base group-hover:bg-transparent">
        ...
        <section className="text-center mt-8">
          <p className="text-base sm:text-lg">¡Gracias por ser parte de esta comunidad! 💻🎓</p>
        </section>
      </section>
    </>
  )
