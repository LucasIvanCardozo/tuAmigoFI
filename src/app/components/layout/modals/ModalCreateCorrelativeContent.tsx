  ...
  return (
    <form className="relative flex flex-col w-full" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col *:flex *:gap-1">
          <div className="flex flex-col">
            ...
            <select
              ...
              name="correlative"
              id="correlative"
              onChange={(e) => setIdCorrelative(e.target.value)}
              required
            >
              {courses ? (
                <>
      ...
      <div className="my-2">
        ...
        <p className="text-xs">
          Por favor verifica que el link que quiere subir sea el correcto. Los links tienen que ser
          de alta prioridad. En caso de cualquier problema podes contactarme:{' '}
          <a
            className="underline"
            target="_blank"
