'use client';
import React, { type ComponentProps, type JSX, useImperativeHandle } from 'react';
  ...
  return (
    <>
      ...
      <ReactModal
        isOpen={isOpen}
        {...rest}
        className="fixed inset-0 z-100 bg-slate-800/50 text-white flex justify-center items-center"
      >
