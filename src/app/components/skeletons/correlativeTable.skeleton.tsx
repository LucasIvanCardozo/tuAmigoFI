  ...
  return (
    <div className="pl-2 my-1">
      ...
      <div className="flex h-6 gap-1 text-sm text-[--black-olive] sm:h-auto">
        ...
        <div className="flex min-h-6 items-center overflow-x-auto overflow-y-hidden sm:overflow-hidden sm:flex-wrap bg-[--platinum] rounded-md opacity-65 animate-[pulse_1s_cubic-bezier(0.4,0,0.6,1)_infinite] transform-gpu grow"></div>
      </div>
    </div>
  );
}
